...
var AWS = __webpack_require__(859);
var util = __webpack_require__(477);
var Rest = __webpack_require__(533);
...
(function() {
  ...
  ref = __webpack_require__(828), isObject = ref.isObject, isFunction = ref.isFunction, isEmpty = ref.isEmpty;
  ...
  module.exports = XMLNode = (function() {
    function XMLNode(parent) {
      ...
      this.children = [];
      if (!XMLElement) {
        XMLElement = __webpack_require__(514);
        XMLCData = __webpack_require__(269);
        XMLComment = __webpack_require__(954);
        XMLDeclaration = __webpack_require__(972);
        XMLDocType = __webpack_require__(807);
        XMLRaw = __webpack_require__(265);
        XMLText = __webpack_require__(489);
        XMLProcessingInstruction = __webpack_require__(566);
      }
    }
...
(function() {
  ...
  XMLDTDElement = __webpack_require__(217);

  XMLDTDEntity = __webpack_require__(94);

  XMLDTDNotation = __webpack_require__(984);

  XMLWriterBase = __webpack_require__(861);
...
var AWS = __webpack_require__(859);
var inherit = AWS.util.inherit;
var jmespath = __webpack_require__(733);
...
var EventMessageChunkerStream = __webpack_require__(756).EventMessageChunkerStream;
var EventUnmarshallerStream = __webpack_require__(870).EventUnmarshallerStream;
...
(function() {
  ...
  isObject = __webpack_require__(828).isObject;

  XMLNode = __webpack_require__(39);
...
var util = __webpack_require__(859).util;
...
var eventMessageChunker = __webpack_require__(743).eventMessageChunker;
var parseEvent = __webpack_require__(977).parseEvent;
...
var escapeElement = __webpack_require__(40).escapeElement;
...
(function() {
  ...
  isPlainObject = __webpack_require__(828).isPlainObject;

  XMLNode = __webpack_require__(39);

  XMLStringifier = __webpack_require__(631);

  XMLStringWriter = __webpack_require__(297);
...
(function() {
  ...
  ref = __webpack_require__(828), isObject = ref.isObject, isFunction = ref.isFunction, isPlainObject = ref.isPlainObject;
  ...
  XMLAttribute = __webpack_require__(392);
...
var Int64 = __webpack_require__(210).Int64;

var splitMessage = __webpack_require__(173).splitMessage;
...
var AWS = __webpack_require__(859);
var STS = __webpack_require__(763);
...
var rng = __webpack_require__(902);
...
var AWS = __webpack_require__(859);
var AcceptorStateMachine = __webpack_require__(868);
var inherit = AWS.util.inherit;
...
var Collection = __webpack_require__(730);
var Operation = __webpack_require__(504);
var Shape = __webpack_require__(452);
var Paginator = __webpack_require__(705);
var ResourceWaiter = __webpack_require__(750);
var metadata = __webpack_require__(299);
...
var escapeAttribute = __webpack_require__(688).escapeAttribute;
...
(function() {
  ...
  builder = __webpack_require__(555);

  defaults = __webpack_require__(252).defaults;
...
var util = __webpack_require__(477);
var XmlNode = __webpack_require__(349).XmlNode;
var XmlText = __webpack_require__(122).XmlText;
...
var util = __webpack_require__(859).util;
var typeOf = __webpack_require__(564).typeOf;
...
Object.defineProperty(apiLoader.services['dynamodb'], '2011-12-05', {
  get: function get() {
    ...
    model.waiters = __webpack_require__(58).waiters;
    return model;
  },
  enumerable: true,
  configurable: true
...
Object.defineProperty(apiLoader.services['dynamodb'], '2012-08-10', {
  get: function get() {
    ...
    model.paginators = __webpack_require__(65).pagination;
    model.waiters = __webpack_require__(691).waiters;
    return model;
  },
  enumerable: true,
  configurable: true
...
util.createEventStream = util.stream.Readable ?
  __webpack_require__(88).createEventStream : __webpack_require__(116).createEventStream;
util.realClock = __webpack_require__(8);
util.clientSideMonitoring = {
  Publisher: __webpack_require__(926).Publisher,
  configProvider: __webpack_require__(707),
};
util.iniLoader = __webpack_require__(741).iniLoader;
 ...
 * @api private
 */
module.exports = AWS = __webpack_require__(859);
...
AWS.XML.Parser = __webpack_require__(922);
...
var util = {
  ...
  userAgent: function userAgent() {
    ...
    var agent = 'aws-sdk-' + name + '/' + __webpack_require__(859).VERSION;
  ...
  date: {
    ...
    getDate: function getDate() {
      if (!AWS) AWS = __webpack_require__(859);
  ...
  uuid: {
    v4: function uuidV4() {
      return __webpack_require__(849).v4();
    }
  },
...
(function() {
  ...
  ref = __webpack_require__(828), isObject = ref.isObject, isFunction = ref.isFunction;
...
var util = __webpack_require__(477);
var JsonBuilder = __webpack_require__(736);
var JsonParser = __webpack_require__(169);
var populateHostPrefix = __webpack_require__(645).populateHostPrefix;
...
(function() {
  ...
  ref = __webpack_require__(828), assign = ref.assign, isFunction = ref.isFunction;

  XMLDocument = __webpack_require__(142);
...
var AWS = __webpack_require__(859);
var v4Credentials = __webpack_require__(427);
var inherit = AWS.util.inherit;
...
(function() {
  ...
  sax = __webpack_require__(582);

  events = __webpack_require__(614);

  bom = __webpack_require__(105);

  processors = __webpack_require__(996);

  setImmediate = __webpack_require__(509).setImmediate;
...
var util = __webpack_require__(477);
var regionConfig = __webpack_require__(700);
...
var AWS = __webpack_require__(859);
var CognitoIdentity = __webpack_require__(992);
var STS = __webpack_require__(763);
...
var property = __webpack_require__(477).property;
...
var AWS = __webpack_require__(859);
var SequentialExecutor = __webpack_require__(103);
var DISCOVER_ENDPOINT = __webpack_require__(343).discoverEndpoint;
/**
...
AWS.EventListeners = {
  ...
  Json: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __webpack_require__(527);
  ...
  Rest: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __webpack_require__(533);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  }),
  ...
  RestJson: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __webpack_require__(836);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  }),
  ...
  Query: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __webpack_require__(896);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  })
...
var memoizedProperty = __webpack_require__(477).memoizedProperty;
...
var IniLoader = __webpack_require__(962).IniLoader;
/**
...
var AWS = __webpack_require__(859);
var Api = __webpack_require__(328);
var regionConfig = __webpack_require__(599);
...
Object.defineProperty(apiLoader.services['sts'], '2011-06-15', {
  get: function get() {
    ...
    model.paginators = __webpack_require__(502).pagination;
    return model;
  },
  enumerable: true,
  configurable: true
...
(function() {
  ...
  defaults = __webpack_require__(252);

  builder = __webpack_require__(363);

  parser = __webpack_require__(581);
...
var AWS = __webpack_require__(859);
var Translator = __webpack_require__(985);
var DynamoDBSet = __webpack_require__(426);
...
var util = __webpack_require__(477);
var Rest = __webpack_require__(533);
var Json = __webpack_require__(527);
var JsonBuilder = __webpack_require__(736);
var JsonParser = __webpack_require__(169);
...
var v1 = __webpack_require__(314);
 ...
 */
var AWS = { util: __webpack_require__(477) };
...
AWS.util.update(AWS, {
   ...
   */
  Protocol: {
    Json: __webpack_require__(527),
    Query: __webpack_require__(896),
    Rest: __webpack_require__(533),
    RestJson: __webpack_require__(836),
    RestXml: __webpack_require__(3)
  },
   ...
   */
  XML: {
    Builder: __webpack_require__(386),
   ...
   */
  JSON: {
    Builder: __webpack_require__(736),
   ...
   */
  Model: {
    Api: __webpack_require__(328),
    Operation: __webpack_require__(504),
    Shape: __webpack_require__(452),
    Paginator: __webpack_require__(705),
    ResourceWaiter: __webpack_require__(750)
  },

  /**
   * @api private
   */
  apiLoader: __webpack_require__(73),

  /**
   * @api private
   */
  EndpointCache: __webpack_require__(886).EndpointCache
});
...
var typeOf = __webpack_require__(564).typeOf;
var DynamoDBSet = __webpack_require__(426);
var NumberValue = __webpack_require__(102);
...
Object.defineProperty(exports, "__esModule", { value: true });
var LRU_1 = __webpack_require__(44);
var CACHE_SIZE = 1000;
/**
...
var AWS = __webpack_require__(859);
var resolveRegionalEndpointsFlag = __webpack_require__(255);
...
var AWS = __webpack_require__(859);
var util = __webpack_require__(477);
var QueryParamSerializer = __webpack_require__(661);
var Shape = __webpack_require__(452);
var populateHostPrefix = __webpack_require__(645).populateHostPrefix;
...
var xml2js = __webpack_require__(809);
...
const DynamoDB = __webpack_require__(449);
...
var parseMessage = __webpack_require__(185).parseMessage;
...
var util = __webpack_require__(859).util;
var convert = __webpack_require__(883);
